...
module.exports = {
    ...
    - Every pokemon statistics for every form/evolution: Additional pool ?, Types, Rarity, Heath, Attack, Defense Special, Defense, Attack range, PP. Missing statistic proposition will be deleted.
